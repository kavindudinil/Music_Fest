...
const UpdateOrganizerA: React.FC<UpdateArtistProps> = ({
                                                          initialValues,
                                                          onSubmit,
                                                          onCancel
                                                      }) => {
    ...
    const handleSubmit = async (values: OrganizerData) => {
        try {
            ...
            if (response.status === 200) {
                localStorage.setItem("AdministratorData", JSON.stringify(response.data.content));
...
export default UpdateOrganizerA;
